  ...
  <div class="container" >
    ...
    <div class="toolbar" v-if="otcPermission[exchange]">
      <div style="margin-right:10px;">
        Binance USDT买入 <el-input-number style="margin-right:5px;" v-model="usdtPrice[exchange].buy" controls-position="right" :min="5.00" :max="9.00" :precision="2" :step="0.01" size="mini"></el-input-number>
      ...
      <el-form ref="settingForm" label-width="100px" label-position="left">
        ...
        <el-form-item label="展示的币">
          ...
          <el-checkbox-group v-model="settingForm.otc">
            <el-checkbox v-for="(item, index) in track.sub_binance.otcRmb" v-bind:key="index" :label="item" name="type">{{item.toUpperCase()}}</el-checkbox>
          </el-checkbox-group>
        </el-form-item>
